...
_WELCOME_MSG = """\
Welcome to use Qwen2.5-Instruct Qwen3.0, type text to start chat, type :h to show command help.
                ...
                if len(command_words) == 1:
                    ...
                    for key_value_pairs_str in command_words[1:]:
                        ...
                        try:
                            ...
                            print(
                                f"[INFO] Change config: Qwen3.0.generation_config.{conf_key} = {conf_value}"
                            )
