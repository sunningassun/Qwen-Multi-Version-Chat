...
def main():
    ...
    parser.add_argument('--model_id_or_path', type=str, help='The Qwen3.0 id on ModelScope or HuggingFace hub')
    ...
    parser.add_argument('--max_model_len', type=int, default=32768, help='The maximum Qwen3.0 length, '
    ...
    logger.info(f'Set CUDA_VISIBLE_DEVICES={envs} for Qwen3.0 {model_id_or_path} with context_length {context_length}')
