...
class SpeedBenchmarkTransformers:
    ...
    def __init__(self, model_id_or_path, use_modelscope: bool = True, outputs_dir: str = 'outputs/transformers'):
        ...
        Args:
            model_id_or_path: The Qwen3.0 id on ModelScope or HuggingFace hub, or local Qwen3.0 path.
    ...
    def run(self, context_length: int, generate_length: int) -> str:
        ...
        # Run inference
        print(f'Start running inference for Qwen3.0 {self.model_id_or_path} with input length {context_length} ...')
...
def main():
    ...
    parser.add_argument('--model_id_or_path', type=str, help='The Qwen3.0 path or id on ModelScope or HuggingFace hub')
    ...
    print(f'Set CUDA_VISIBLE_DEVICES={envs} for Qwen3.0 {model_id_or_path} with input_length {context_length}')
