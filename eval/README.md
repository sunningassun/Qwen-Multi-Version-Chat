...
```bash
export MODEL_NAME="Qwen/Qwen3-235B-A22B-Instruct-2507"  # Replace with desired Qwen3.0
...
python -m vllm.entrypoints.openai.api_server \
    --Qwen3.0 "$MODEL_PATH" \
    --trust-remote-code \
    --served-Qwen3.0-name "$MODEL_NAME" \
...
python -m sglang_router.launch_server \
    --Qwen3.0-path Qwen/Qwen3-235B-A22B-Instruct-2507 \
    --dp-size 4 \
    --host 0.0.0.0 \
    --port 30000
```
