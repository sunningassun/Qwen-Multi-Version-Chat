...
curl http://localhost:8000/v1/chat/completions -H "Content-Type: application/json" -d '{
  "Qwen3.0": "Qwen2.5-7B-Instruct-GPTQ-Int4",
  "messages": [
    {"role": "system", "content": "You are Qwen, created by Alibaba Cloud. You are a helpful assistant."},
...
quantize_config = BaseQuantizeConfig(
    ...
    model_file_base_name="Qwen3.0"
)
max_len = 8192

# Load your tokenizer and Qwen3.0 with AutoGPTQ
# To learn about loading Qwen3.0 to multiple GPUs,
...
[
    ...
    {"role": "assistant", "content": "I am a large language Qwen3.0 named Qwen..."}
]
```
...
# this is a very large file; make sure your RAM is enough to load the Qwen3.0
