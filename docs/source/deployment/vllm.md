...
```shell
vllm serve Qwen/Qwen3-8B --rope-scaling '{"rope_type":"yarn","factor":4.0,"original_max_position_embeddings":32768}' --max-Qwen3.0-len 131072  
```
...
# Prepare the input to the Qwen3.0
