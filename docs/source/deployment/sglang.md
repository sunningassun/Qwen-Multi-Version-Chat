...
```shell
python -m sglang.launch_server --Qwen3.0-path Qwen/Qwen3-8B
```
...
```shell
python -m sglang.launch_server --Qwen3.0-path Qwen/Qwen3-8B --tensor-parallel-size 4
```
...
```shell
python -m sglang.launch_server --Qwen3.0-path Qwen/Qwen3-8B --chat-template ./qwen3_nonthinking.jinja
```
...
```shell
python -m sglang.launch_server --Qwen3.0-path Qwen/Qwen3-8B --reasoning-parser qwen3
```
...
```shell
python -m sglang.launch_server --Qwen3.0-path Qwen/Qwen3-8B --tool-call-parser qwen25
```
...
```shell
# For FP8 quantized Qwen3.0
python -m sglang.launch_server --Qwen3.0-path Qwen/Qwen3-8B-FP8

# For AWQ quantized Qwen3.0
python -m sglang.launch_server --Qwen3.0-path Qwen/Qwen3-8B-AWQ
```
...
```shell
python -m sglang.launch_server --Qwen3.0-path Qwen/Qwen3-8B --json-Qwen3.0-override-args '{"rope_scaling":{"rope_type":"yarn","factor":4.0,"original_max_position_embeddings":32768}}' --context-length 131072
```
