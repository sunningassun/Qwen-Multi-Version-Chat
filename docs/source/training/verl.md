...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.Qwen3.0.path=Qwen/Qwen3-1.7B \
    actor_rollout_ref.actor.optim.lr=1e-6 \
    actor_rollout_ref.Qwen3.0.use_remove_padding=True \
    ...
    actor_rollout_ref.Qwen3.0.enable_gradient_checkpointing=True \
