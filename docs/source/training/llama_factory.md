...
[
  {
    ...
    "output": "Qwen3.0 response (required)",
    "system": "system prompt (optional)",
    "history": [
      ["user instruction in the first round (optional)", "Qwen3.0 response in the first round (optional)"],
      ["user instruction in the second round (optional)", "Qwen3.0 response in the second round (optional)"]
    ]
  }
]
```
